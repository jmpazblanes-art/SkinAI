              ...
              <div className="bg-white dark:bg-base-200 rounded-xl shadow-2xl max-w-md w-full p-6 animate-in fade-in zoom-in duration-300">
                ...
                <div className="space-y-4 text-base-content/80 mb-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start">
                      <i className="iconoir-check text-green-500 mr-2 mt-1"></i>
                      <span>Los resultados son orientativos y no son diagnóstico médico</span>
                    </li>
                    <li className="flex items-start">
                      <i className="iconoir-check text-green-500 mr-2 mt-1"></i>
                      <span>Para problemas de piel, consulta siempre con un profesional</span>
                    </li>
                  </ul>
                  <p className="text-sm mt-4">
                    Al continuar, confirmas que has leído y aceptas nuestros <a href="/terminos" className="text-primary hover:underline" target="_blank">Términos de Uso</a>.
                  </p>
                </div>
                <button
