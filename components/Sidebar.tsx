...
const ThemeToggle: React.FC = () => {
    ...
    return (
      <div className="flex items-center justify-between p-2 rounded-lg bg-base-200">
        ...
        <button
          onClick={toggleTheme}
          className={`relative inline-flex items-center h-6 rounded-full w-11 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary focus:ring-offset-base-200 ${
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-t border-base-300/60 space-y-4">
                ...
                <div className={`p-4 rounded-lg bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/50 dark:to-primary/20 text-center`}>
                    ...
                    <button className="mt-3 w-full bg-primary text-white py-2 rounded-lg text-sm font-semibold hover:bg-primary-focus transition-transform duration-200 hover:-translate-y-0.5">Actualizar</button>
                </div>
            </div>
        </div>
      </div>
