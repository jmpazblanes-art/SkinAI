...
serve(async (req) => {
    ...
    IMPORTANTE: Usa lenguaje puramente cosmético. ESTÁ TERMINANTEMENTE PROHIBIDO usar los términos: 'diagnóstico', 'médico', 'cura', 'tratamiento', 'enfermedad', 'clínica', 'especialista', 'sanitario'. Habla solo de 'sugerencias', 'rutinas' y 'cuidados'.
