...
interface AnalysisContextType {
  ...
  setLatestAnalysis: (result: AnalysisResult | null, image: string, addToHistory?: boolean) => void;
...
const generateRoutineForAnalysis = (analysis: AnalysisResult): DailyRoutineStep[] => {
    ...
    if (mainProblem) {
        ...
        } else if (issue.includes('enrojecimiento') || analysis.skinType === 'sensitive') {
...
export const AnalysisProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const setLatestAnalysis = (result: AnalysisResult | null, imageUrl: string, addToHistory = true) => {
    if (result && imageUrl) {
        const newAnalysis: AnalysisResultWithImage = { result, imageUrl };
