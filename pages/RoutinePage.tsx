  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-base-content mb-2">Sugerencias de Cuidado Diario</h1>
          <p className="text-gray-600 dark:text-gray-400">Estas sugerencias están basadas en las características observadas en tu foto. Son orientativas y para fines de bienestar general.</p>
        </div>
        {streak > 0 && (
